...
@section('content')
    ...
    <div class="page-content">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <ul class="post-job-bx">
                            ...
                            @else
                                <p>There's no job at the moment!</p>
                            @endif
        ...
        <!-- Our Latest Blog -->
        <div class="section-full content-inner-2 overlay-white-middle" style="background-image:url(assets/images/lines.png); background-position:bottom; background-repeat:no-repeat; background-size: 100%;">
            <div class="container">
