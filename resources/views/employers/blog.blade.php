        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(assets/images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white"> Employers Blog </h1>
					<!-- Breadcrumb row -->
					<div class="breadcrumb-row">
						<ul class="list-inline">
							<li><a href="#">Home</a></li>
							<li> Employers Blog </li>
						</ul>
					</div>
					<!-- Breadcrumb row END -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-12">
						...
						<div class="blog-post blog-lg blog-style-1">
							<div class="dez-post-media dez-img-effect zoom-slow radius-sm"> <a href="#"><img src="{{ asset('assets/images/blog/default/thum2.jpg') }}" alt=""></a> </div>
							<div class="dez-info">
						...
						<div class="blog-post blog-lg blog-style-1">
							<div class="dez-post-media dez-img-effect zoom-slow radius-sm"> <a href="#"><img src="{{ asset('assets/images/blog/default/thum1.jpg') }}" alt=""></a> </div>
							<div class="dez-info">
								 <div class="dez-post-meta">
									<ul class="d-flex align-items-center">
										<li class="post-date"><i class="fa fa-calendar"></i>September 18, 2017</li>
						...
						<div class="blog-post blog-lg blog-style-1">
							<div class="dez-post-media dez-img-effect zoom-slow radius-sm"> <a href="#"><img src="{{ asset('assets/images/blog/default/thum4.jpg') }}" alt=""></a> </div>
							<div class="dez-info">
								 <div class="dez-post-meta">
									<ul class="d-flex align-items-center">
										<li class="post-date"><i class="fa fa-calendar"></i>September 18, 2017</li>
						...
						<div class="blog-post blog-lg blog-style-1">
							<div class="dez-post-media dez-img-effect zoom-slow radius-sm"> <a href="#"><img src="{{ asset('assets/images/blog/default/thum3.jpg') }}" alt=""></a> </div>
							<div class="dez-info">
								 <div class="dez-post-meta">
									<ul class="d-flex align-items-center">
										<li class="post-date"><i class="fa fa-calendar"></i>September 18, 2017</li>
                    ...
                    <div class="col-lg-4 col-md-5 col-sm-12 sticky-top">
                        <aside  class="side-bar">
                            ...
                            <div class="widget recent-posts-entry">
                                ...
                                <div class="widget-post-bx">
                                    <div class="widget-post clearfix">
                                        <div class="dez-post-media"> <img src="{{ asset('assets/images/blog/recent-blog/pic1.jpg') }}" width="200" height="143" alt=""> </div>
                                    ...
                                    <div class="widget-post clearfix">
                                        <div class="dez-post-media"> <img src="{{ asset('assets/images/blog/recent-blog/pic2.jpg') }}" width="200" height="160" alt=""> </div>
                                        <div class="dez-post-info">
                                            <div class="dez-post-header">
                                    ...
                                    <div class="widget-post clearfix">
                                        <div class="dez-post-media"> <img src="{{ asset('assets/images/blog/recent-blog/pic3.jpg') }}" width="200" height="160" alt=""> </div>
                                        <div class="dez-post-info">
                                            <div class="dez-post-header">
							...
							<div class="widget widget_gallery gallery-grid-3">
                                ...
                                <ul>
                                    <li><div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow"><img src="{{ asset('assets/images/gallery/pic2.jpg') }}" alt=""></a></div></li>
                                    <li><div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow"><img src="{{ asset('assets/images/gallery/pic1.jpg') }}" alt=""></a></div></li>
                                    <li><div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow"><img src="{{ asset('assets/images/gallery/pic5.jpg') }}" alt=""></a></div></li>
                                    <li><div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow"><img src="{{ asset('assets/images/gallery/pic7.jpg') }}" alt=""></a></div></li>
                                    <li><div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow"><img src="{{ asset('assets/images/gallery/pic8.jpg') }}" alt=""></a></div></li>
                                    <li><div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow"><img src="{{ asset('assets/images/gallery/pic9.jpg') }}" alt=""></a></div></li>
                                </ul>
                            </div>
