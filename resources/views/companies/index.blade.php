            ...
            <div class="container">
                ...
                <ul id="masonry" class="dez-gallery-listing gallery-grid-4 gallery mfp-gallery">
                    ...
                    <li class="web card-container col-lg-3 col-md-4 col-sm-4">
                        <div class="dez-gallery-box">
                            <div class="dez-media overlay-black-light">
                                <a href="javascript:void(0);"> <img src="{{ asset('assets/images/gallery/pic1.jpg') }}"  alt=""> </a>
                                <div class="overlay-icon overlay-logo">
                                    <img src="{{ asset('assets/images/logo/logo/logo1.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="advertising card-container col-lg-3 col-md-4 col-sm-4">
                        <div class="dez-gallery-box">
                            <div class="dez-media overlay-black-light">
                                ...
                                <div class="overlay-icon overlay-logo">
                                    <img src="{{ asset('assets/images/logo/logo/logo2.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="branding card-container col-lg-3 col-md-4 col-sm-4">
                        <div class="dez-gallery-box">
                            <div class="dez-media overlay-black-light">
                                ...
                                <div class="overlay-icon overlay-logo">
                                    <img src="{{ asset('assets/images/logo/logo/logo3.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="design card-container col-lg-3 col-md-4 col-sm-4">
                        <div class="dez-gallery-box">
                            <div class="dez-media overlay-black-light">
                                <a href="javascript:void(0);"> <img src="{{ asset('assets/images/gallery/pic4.jpg') }}"  alt=""> </a>
                                <div class="overlay-icon overlay-logo">
                                    <img src="{{ asset('assets/images/logo/logo/logo4.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="photography card-container col-lg-3 col-md-4 col-sm-4">
                        <div class="dez-gallery-box">
                            <div class="dez-media overlay-black-light">
                                <a href="javascript:void(0);"> <img src="{{ asset('assets/images/gallery/pic5.jpg') }}"  alt=""> </a>
                                <div class="overlay-icon overlay-logo">
                                    <img src="{{ asset('assets/images/logo/logo/logo1.png') }}" alt="">
                                </div>
                            </div>
                    ...
                    <li class="advertising card-container col-lg-3 col-md-4 col-sm-4">
                        <div class="dez-gallery-box">
                            <div class="dez-media overlay-black-light">
                                <a href="javascript:void(0);"> <img src="{{ asset('assets/images/gallery/pic7.jpg') }}"  alt=""> </a>
                                <div class="overlay-icon overlay-logo">
                                    <img src="{{ asset('assets/images/logo/logo/logo3.png') }}" alt="">
                                </div>
                            </div>
